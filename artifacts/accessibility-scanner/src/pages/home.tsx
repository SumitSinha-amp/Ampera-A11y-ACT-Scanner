...
const ALL_RULES: { id: string; label: string }[] = [
  { id: "SIA-R1",   label: "Page is missing a title element" },
  { id: "SIA-R2",   label: "Image is missing alt text" },
  { id: "SIA-R3",   label: "Duplicate ID found" },
  { id: "SIA-R4",   label: "HTML lang attribute is missing" },
  { id: "SIA-R8",   label: "Form field has no accessible name" },
  { id: "SIA-R11",  label: "Link has no accessible name" },
  { id: "SIA-R12",  label: "Button has no accessible name" },
  { id: "SIA-R14",  label: "Visible label and accessible name do not match" },
  { id: "SIA-R16",  label: "Required ARIA attribute is missing" },
  { id: "SIA-R21",  label: "Invalid ARIA role" },
  { id: "SIA-R22",  label: "Video element may be missing captions" },
  { id: "SIA-R30",  label: "Text contrast ratio below AAA minimum (7:1 / 4.5:1)" },
  { id: "SIA-R31",  label: "Line height is below minimum value (1.4.8)" },
  { id: "SIA-R32",  label: "Interactive element does not meet enhanced target size (2.5.5)" },
  { id: "SIA-R34",  label: "Content missing after heading" },
  { id: "SIA-R35",  label: "Text content is not included in an ARIA landmark" },
  { id: "SIA-R36",  label: "ARIA attribute is unsupported or prohibited on this element" },
  { id: "SIA-R40",  label: "Data table is missing header cells" },
  { id: "SIA-R42",  label: "List item is not inside a list element" },
  { id: "SIA-R47",  label: "Viewport zoom is disabled via meta tag" },
  { id: "SIA-R48",  label: "Media element is autoplaying with audio" },
  { id: "SIA-R58",  label: "Page may be missing a skip navigation link" },
  { id: "SIA-R64",  label: "Heading level is skipped (heading hierarchy)" },
  { id: "SIA-R65",  label: "CSS may be removing focus indicators" },
  { id: "SIA-R68",  label: "Text may be clipped when resized (1.4.4 Resize Text)" },
  { id: "SIA-R69",  label: "Text contrast ratio below AA minimum (4.5:1 / 3:1)" },
  { id: "SIA-R87",  label: "Page is missing landmark regions" },
  { id: "SIA-R114", label: "Iframe is missing a title attribute" },
  { id: "SIA-R116", label: "Select element has no accessible name" },
  { id: "SIA-R117", label: "SVG is missing an accessible name" },
];
