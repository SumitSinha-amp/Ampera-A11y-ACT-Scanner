...
const ruleReferences = [
  ...
  {
    id: "SIA-R11",
    title: "Link does not have a discernible name",
    detail:
  ...
  {
    id: "SIA-R12",
    title: "Button does not have a discernible name",
    detail:
  ...
  {
    id: "SIA-R13",
    title: "Inline frame does not have an accessible name",
    detail:
  ...
  {
    id: "SIA-R14",
    title: "Visible label is not included in the accessible name",
    detail:
  ...
  {
    id: "SIA-R17",
    title: "Hidden content contains focusable elements",
    detail:
  ...
  {
    id: "SIA-R19",
    title: "Invalid value for ARIA attribute",
    detail:
  ...
  {
    id: "SIA-R20",
    title: "Invalid ARIA attribute is used",
    detail:
  ...
  {
    id: "SIA-R22",
    title: "Video does not have captions",
    detail:
  ...
  },
  {
    ...
    detail:
      "The programmatic accessible name must include the visible label text. A mismatch means speech-input users say one thing but the browser acts on something else, preventing successful activation.",
  },
  {
    id: "SIA-R26",
    title: "Abbreviation does not have an expansion",
    detail:
      'Abbreviations and acronyms should be wrapped in <abbr title="…"> with the full expansion so assistive technologies and users unfamiliar with the term can understand it.',
  },
  {
    id: "SIA-R27",
    title: "Audio-only content does not have a transcript",
    detail:
      "Pre-recorded audio-only content (e.g., a podcast) must include a full text transcript so deaf users or those in sound-sensitive environments can access the content.",
  },
  {
    id: "SIA-R28",
    title: "Image button does not have a text alternative",
    detail:
  ...
  {
    id: "SIA-R29",
    title: "Video-only content does not have an alternative",
    detail:
      "Video without audio (silent film, animation, screen recording) must include a text description or equivalent so blind users receive the same information.",
  },
  {
    id: "SIA-R30",
    title: "Enhanced contrast is insufficient (AAA 7:1)",
    detail:
      "Text must meet at least a 7:1 contrast ratio against its background for WCAG Level AAA conformance. This benefits users with moderate to severe low vision.",
  },
  {
    id: "SIA-R31",
    title: "Line height is below recommended minimum",
    detail:
      "Line height (line-height) should be at least 1.5 times the font size. Insufficient line spacing makes text harder to read, particularly for users with dyslexia.",
  },
  {
    id: "SIA-R32",
  ...
  {
    id: "SIA-R35",
    title: "Content is not placed within landmark regions",
    detail:
      "All visible body content should be contained within an appropriate ARIA landmark (main, nav, header, footer, etc.) so keyboard users can navigate directly to each region.",
  },
  {
    id: "SIA-R36",
  ...
  {
    id: "SIA-R37",
    title: "Video does not have an audio description",
    detail:
  ...
  {
    id: "SIA-R38",
    title: "Video alternative may be incomplete",
    detail:
  ...
  {
    id: "SIA-R40",
    title: "Landmark region does not have an accessible name",
    detail:
  ...
  {
    id: "SIA-R42",
    title: "ARIA role is not used in the correct context",
    detail:
  ...
  {
    id: "SIA-R43",
    title: "SVG or graphical element lacks accessible name",
    detail:
  ...
  {
    id: "SIA-R44",
    title: "Page orientation is restricted",
    detail:
  ...
  {
    id: "SIA-R45",
    title: "Table headers are not properly defined",
    detail:
  ...
  {
    id: "SIA-R46",
    title: "Table cells are not associated with headers",
    detail:
      'Data cells (<td>) must be programmatically associated with their headers — either by placing them under a <th scope="col"> or by using the headers attribute — so screen readers can announce the relationship.',
  },
  {
    id: "SIA-R47",
  ...
  {
    id: "SIA-R48",
    title: "Audio or media plays automatically",
    detail:
  ...
  {
    id: "SIA-R53",
    title: "Headings are not structured properly",
    detail:
  ...
  {
    id: "SIA-R54",
    title: "Status message not announced to assistive technologies",
    detail:
  ...
  {
    id: "SIA-R56",
    title: "Region roles may be misused",
    detail:
  ...
  {
    id: "SIA-R58",
    title: "Skip navigation link may be missing",
    detail:
      "A 'Skip to main content' link at the top of the page lets keyboard users bypass repeated navigation and jump directly to the primary content area.",
  },
  {
    id: "SIA-R59",
    title: "Page does not contain any headings",
    detail:
  ...
  {
    id: "SIA-R60",
    title: "Grouped form controls do not have an accessible name",
    detail:
  ...
  {
    id: "SIA-R61",
    title: "Page does not start with a level-1 heading",
    detail:
  ...
  {
    id: "SIA-R62",
    title: "Links are not visually distinguishable from surrounding text",
    detail:
  ...
  {
    id: "SIA-R63",
    title: "Embedded object does not have a text alternative",
    detail:
  ...
  {
    id: "SIA-R64",
    title: "Heading element is empty",
    detail:
  ...
  {
    id: "SIA-R66",
    title: "Enhanced text contrast is insufficient",
    detail:
  ...
  {
    id: "SIA-R69",
    title: "Text contrast is insufficient (AA 4.5:1)",
    detail:
  ...
  {
    id: "SIA-R70",
    title: "Deprecated HTML element is used",
    detail:
  ...
  {
    id: "SIA-R72",
    title: "Text is written in all capital letters",
    detail:
      "Extended passages in ALL CAPS are significantly harder to read, especially for users with dyslexia. Use sentence case or title case for body text, and avoid text-transform:uppercase on long passages.",
  },
  {
    id: "SIA-R73",
    title: "Line height is too small",
    detail:
  ...
  {
    id: "SIA-R77",
    title: "Table data cells are not properly associated with headers",
    detail:
  ...
  {
    id: "SIA-R79",
    title: "Preformatted text element is misused",
    detail:
  ...
  {
    id: "SIA-R85",
    title: "Text uses excessive italics",
    detail:
  ...
  {
    id: "SIA-R86",
    title: "Presentational element exposed to assistive technologies",
    detail:
  ...
  {
    id: "SIA-R87",
    title: "Skip navigation link is missing",
    detail:
      "A skip link at the top of each page allows keyboard and screen reader users to jump past the repeated navigation and reach the main content immediately.",
  },
  {
    id: "SIA-R88",
    title: "Word spacing is insufficient",
    detail:
      "When users apply their own CSS to increase word spacing (per WCAG 1.4.12), content must remain readable. Avoid fixed layouts that collapse when word-spacing is increased to 0.16em.",
  },
  {
    id: "SIA-R89",
    title: "Enhanced contrast is insufficient (AAA)",
    detail:
  ...
  {
    id: "SIA-R93",
    title: "Line height is insufficient",
    detail:
  ...
  {
    id: "SIA-R94",
    title: "Menu item does not have an accessible name",
    detail:
  ...
  {
    id: "SIA-R95",
    title: "Keyboard interaction is not supported",
    detail:
  ...
  {
    id: "SIA-R96",
    title: "Page refresh or update occurs without warning",
    detail:
  ...
  {
    id: "SIA-R97",
    title: "Collapsible content may not be accessible",
    detail:
  ...
  {
    id: "SIA-R98",
    title: "Main content may lack a heading",
    detail:
  ...
  {
    id: "SIA-R100",
    title: "PDF does not have an accessible alternative",
    detail:
  ...
  {
    id: "SIA-R101",
    title: "Skip navigation link is missing (alternative check)",
    detail:
      "A supplementary check for a bypass mechanism. If a skip link was not found by earlier rules, this rule confirms its absence. Provide a 'Skip to main content' link.",
  },
  {
    id: "SIA-R102",
    title: "Skip navigation link is missing (secondary check)",
    detail:
  ...
  {
    id: "SIA-R104",
    title: "Enhanced contrast is insufficient",
    detail:
  ...
  {
    id: "SIA-R110",
    title: "HTML lang attribute contains an invalid language code",
    detail:
      'The primary language subtag in the lang attribute (e.g., the "en" in "en-US") must match a valid ISO 639 code. An invalid subtag prevents correct voice and dictionary selection.',
  },
  {
    id: "SIA-R111",
...
const references = [
  {
    ...
    description:
      "Use this as the primary rule reference when interpreting scanner findings and prioritizing fixes.",
    links: [
      {
        label: "Alfa Rules Catalog",
        href: "https://alfa.siteimprove.com/rules",
      },
      {
        label: "Siteimprove Help Center",
        href: "https://help.siteimprove.com/",
      },
      {
        label: "WCAG 2.1 Overview",
  ...
  },
  {
    ...
    description:
      "This scanner maps a curated rule set to practical fixes for pages, components, and content flows.",
    links: [
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Use the rule catalog to navigate findings and understand likely
            remediation paths.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <p className="text-muted-foreground">
            When a rule is triggered, review the issue summary first, then
            expand occurrences to inspect selectors, HTML, WCAG criteria, and
            conformance level.
          </p>
      ...
      <Card>
        ...
        <CardContent className="text-sm leading-6 text-muted-foreground space-y-3">
          <p>
            Siteimprove, WCAG, and any referenced standards, names, or
            trademarks remain the property of their respective owners.
          </p>
          <p>
            This tool is provided for accessibility auditing and educational
            use. Always verify licensing terms before reproducing external
            documentation, rule text, or brand assets in your own materials.
          </p>
        </CardContent>
      </Card>
    </div>
