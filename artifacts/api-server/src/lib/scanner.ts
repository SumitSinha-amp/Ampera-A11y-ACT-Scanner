...
> = {
  "SIA-R1": {
    ...
    remediation:
      "Add a descriptive <title> element to the <head> of the document",
  },
  "SIA-R2": {
    description: "Image is missing alt text",
    remediation:
      "Add an alt attribute to all img elements. Use empty alt='' for decorative images",
  },
  "SIA-R3": {
    description: "Duplicate ID found",
    remediation: "Ensure all id attributes on the page are unique",
  },
  "SIA-R4": {
  ...
  "SIA-R8": {
    ...
    remediation:
      "Associate a <label> element with each form field using for/id attributes or aria-label",
  },
  "SIA-R11": {
    description: "Link has no accessible name",
    remediation:
      "Add descriptive text content, aria-label, or aria-labelledby to all links",
  },
  "SIA-R12": {
    description: "Button has no accessible name",
    remediation: "Add descriptive text content or aria-label to all buttons",
  },
  "SIA-R14": {
    description: "Visible label and accessible name do not match",
    remediation:
      "Ensure the accessible name of an interactive element contains the visible label text",
  },
  "SIA-R16": {
  ...
  "SIA-R21": {
    ...
    remediation:
      "Use only valid ARIA role values as defined in the ARIA specification",
  },
  "SIA-R22": {
    description: "Video element may be missing captions",
    remediation: "Add a <track kind='captions'> element to all video elements",
  },
  "SIA-R40": {
    description: "Data table is missing header cells",
    remediation:
      "Add <th> elements to table rows/columns or use scope attributes",
  },
  "SIA-R42": {
    description: "List item is not inside a list element",
    remediation: "Ensure <li> elements are always inside <ul> or <ol> elements",
  },
  "SIA-R44": {
    description: "Page may be restricting screen orientation",
    remediation:
      "Remove CSS that restricts screen orientation unless essential to functionality",
  },
  "SIA-R47": {
    description: "Viewport zoom is disabled via meta tag",
    remediation:
      "Remove user-scalable=no or maximum-scale=1 from the viewport meta tag",
  },
  "SIA-R48": {
    description: "Media element is autoplaying with audio",
    remediation:
      "Do not autoplay audio; provide user controls to start playback",
  },
  "SIA-R58": {
    description: "Page may be missing a skip navigation link",
    remediation: "Add a skip-to-content link as the first focusable element",
  },
  "SIA-R84": {
    description: "Scrollable elements are not keyboard accessible",
    remediation:
      "Ensure scrollable containers can receive keyboard focus and can be scrolled with the keyboard, for example by adding tabindex='0' when appropriate",
  },
  "SIA-R65": {
    description: "CSS may be removing focus indicators",
    remediation:
      "Ensure all focusable elements have a visible focus indicator; avoid outline: none without replacement",
  },
  "SIA-R69": {
    description:
      "Text contrast ratio is below AA minimum (4.5:1 normal, 3:1 large)",
    remediation:
      "Ensure text has a contrast ratio of at least 4.5:1 (3:1 for large text) against its background",
  },
  "SIA-R87": {
    description: "Page is missing landmark regions",
    remediation:
      "Add ARIA landmarks (main, nav, header, footer) or HTML5 sectioning elements to the page",
  },
  "SIA-R91": {
    description: "Line height may be too low",
    remediation: "Set line-height to at least 1.5 times the font size",
  },
  "SIA-R92": {
    description: "Letter spacing may be too low",
    remediation: "Ensure letter-spacing is at least 0.12 times the font size",
  },
  "SIA-R93": {
    description: "Word spacing may be too low",
    remediation: "Ensure word-spacing is at least 0.16 times the font size",
  },
  "SIA-R114": {
    description: "Iframe is missing a title attribute",
    remediation:
      "Add a title attribute to all <iframe> elements describing their purpose",
  },
  "SIA-R116": {
    description: "Select element has no accessible name",
    remediation: "Add a <label> or aria-label to all <select> elements",
  },
  "SIA-R117": {
    description: "SVG is missing an accessible name",
    remediation:
      "Add a <title> or aria-label to meaningful SVG elements. Use aria-hidden for decorative SVGs",
  },
  // Extended
  "SIA-R25": {
    description:
      "Visible label and accessible name do not match (Label in Name)",
    remediation:
      "Ensure the accessible name starts with or contains the visible label text verbatim",
  },
  "SIA-R30": {
    description:
      "Text contrast ratio is below AAA enhanced minimum (7:1 normal, 4.5:1 large)",
    remediation:
      "Increase contrast ratio to at least 7:1 for normal text and 4.5:1 for large text",
  },
  "SIA-R31": {
    description:
      "Line height is below minimum value (1.4.8 Visual Presentation)",
    remediation: "Set line-height to at least 1.5× the font-size for body text",
  },
  "SIA-R32": {
    description:
      "Interactive element does not meet enhanced target size (2.5.5)",
    remediation:
      "Ensure interactive elements have a target size of at least 24×24 CSS pixels",
  },
  "SIA-R34": {
    description: "Content missing after heading",
    remediation:
      "Ensure headings are followed by content; avoid using consecutive headings without intervening text",
  },
  "SIA-R35": {
    description: "Text content is not included in an ARIA landmark",
    remediation:
      "Wrap all significant text content within a landmark region (main, nav, aside, footer, etc.)",
  },
  "SIA-R64": {
    description: "Headings are not structured — heading level is skipped",
    remediation:
      "Ensure headings follow a sequential hierarchy without skipping levels (e.g. h1 → h2 → h3); do not jump from h1 to h3",
  },
  "SIA-R36": {
    description: "ARIA attribute is unsupported or prohibited on this element",
    remediation:
      "Remove ARIA attributes that are not permitted on the element's role or native element type",
  },
  "SIA-R68": {
    description: "Text may be clipped when resized (1.4.4 Resize Text)",
    remediation:
      "Avoid fixed heights on text containers with overflow:hidden; use min-height or allow overflow:visible",
  },
  // New rules
  "SIA-R9": {
    description: "Empty heading element",
    remediation:
      "Add descriptive text inside heading elements; do not use empty headings for spacing",
  },
  "SIA-R13": {
    description: "Link opens in new window or tab without warning",
    remediation:
      "Add visible text or an sr-only span indicating the link opens in a new window (e.g. '(opens in new tab)')",
  },
  "SIA-R17": {
    description: "Audio/video element may be missing a text transcript",
    remediation:
      "Provide a text transcript adjacent to or linked from each audio or video element",
  },
  "SIA-R23": {
    description: "Video element may be missing an audio description track",
    remediation:
      "Add a <track kind='descriptions'> element or provide a separate described version of the video",
  },
  "SIA-R26": {
    description: "Abbreviation has no expansion",
    remediation:
      "Wrap abbreviations in <abbr title='Full Form'> or provide an expansion on first use",
  },
  "SIA-R41": {
    description: "Table is missing a caption or summary",
    remediation:
      "Add a <caption> element as the first child of the table to describe its purpose",
  },
  "SIA-R45": {
    description: "Input field is missing autocomplete attribute",
    remediation:
      "Add autocomplete attributes to inputs collecting personal data (name, email, phone, address, etc.)",
  },
  "SIA-R46": {
    description: "Interactive element may be too small for touch targets",
    remediation:
      "Ensure all interactive elements have a minimum size of 24×24 CSS pixels or have sufficient spacing",
  },
  "SIA-R54": {
    description: "Dynamic status message is not announced to screen readers",
    remediation:
      "Use aria-live='polite' or role='status' on containers that receive dynamic status messages",
  },
  "SIA-R57": {
    description:
      "UI component or graphical object may have insufficient contrast",
    remediation:
      "Ensure non-text UI components (icons, borders, focus indicators) have at least 3:1 contrast against adjacent colors",
  },
  "SIA-R59": {
    description: "Link text is ambiguous or non-descriptive",
    remediation:
      "Replace generic link text ('click here', 'read more', 'here') with descriptive text that explains the link destination",
  },
  "SIA-R62": {
    description: "Content section is missing a heading",
    remediation:
      "Add a heading element to introduce each major section of content; use aria-labelledby on landmarks",
  },
  "SIA-R66": {
    description:
      "Form error message is not programmatically associated with its field",
    remediation:
      "Use aria-describedby to link error messages to their form fields, or use aria-invalid='true' on invalid inputs",
  },
  "SIA-R67": {
    description: "Form field is missing a label or instruction",
    remediation:
      "Add a <label>, aria-label, or aria-labelledby to every form control",
  },
  "SIA-R75": {
    description:
      "Image of text — image likely contains text that should be real HTML text",
    remediation:
      "Replace images of text with real text styled with CSS; only use images of text for logos and brand names",
  },
  "SIA-R88": {
    description: "Word spacing may be too low for text readability",
    remediation:
      "Ensure word-spacing is at least 0.16em and that layout does not break at this value",
  },
  "SIA-R95": {
    description: "Animation or motion not respecting prefers-reduced-motion",
    remediation:
      "Wrap CSS animations in @media (prefers-reduced-motion: no-preference) or disable them for reduce-motion users",
  },
  "SIA-R96": {
    description: "Table header cell is missing a scope attribute",
    remediation:
      "Add scope='col' or scope='row' to all <th> elements to explicitly associate them with data cells",
  },
  "SIA-R97": {
    description: "Fieldset is missing a legend element",
    remediation:
      "Add a <legend> as the first child of every <fieldset> to describe the group of form controls",
  },
  "SIA-R98": {
    description: "Expandable element is missing aria-expanded state",
    remediation:
      "Add aria-expanded='true'/'false' to toggle controls (accordions, dropdowns, disclosure buttons)",
  },
  "SIA-R99": {
    description:
      "Focusable element is hidden from assistive technology with aria-hidden",
    remediation:
      "Remove aria-hidden='true' from elements that can receive keyboard focus, or make them non-focusable",
  },
  "SIA-R100": {
    description: "Link to a PDF without an accessible alternative",
    remediation:
      "Provide an accessible HTML alternative alongside the PDF download link",
  },
  "SIA-R104": {
    description: "Page uses meta refresh to redirect or reload",
    remediation:
      "Remove <meta http-equiv='refresh'>; use server-side redirects or notify users before any page refresh",
  },
  "SIA-R105": {
    description:
      "Multiple links with identical text point to different destinations",
    remediation:
      "Make link text unique, or add aria-label to distinguish links with the same visible text",
  },
  "SIA-R107": {
    description: "Custom interactive element is not keyboard accessible",
    remediation:
      "Add tabindex='0', role, and keyboard event handlers (keydown Enter/Space) to custom interactive elements",
  },
  "SIA-R112": {
    description: "Figure element is missing a figcaption",
    remediation:
      "Add a <figcaption> inside <figure> to provide a visible caption for images and other embedded content",
  },
  "SIA-R113": {
    description: "Details element summary has no accessible name",
    remediation:
      "Add descriptive text inside <summary> so screen readers can announce the disclosure widget",
  },
  "SIA-R115": {
    description: "Object element is missing an accessible name",
    remediation:
      "Add a title attribute or aria-label to <object> elements, and provide fallback text content inside",
  },
};
...
async function runSIARules(page: Page): Promise<ScanIssue[]> {
  const results = await page.evaluate(() => {
    ...
    const isScrollable = (el: HTMLElement) => {
      ...
      // Ignore sr-only and truly hidden elements
      if (el.classList.contains("sr-only") || style.display === "none")
        return false;

      // Check if the element has a fixed height/max-height constraint
      const hasHeightConstraint =
        style.maxHeight !== "none" || style.height !== "auto";

      // ACT Rule Logic: Compare scrollHeight to clientHeight
      // For hover-cards, we check if the inner content (scrollHeight)
      // is significantly larger than the container's visible area (clientHeight)
      ...
      // KEY FIX: If it's a hover-reveal card, the scrollHeight usually
      // exceeds the clientHeight even when the 'hover' class is missing
      // because the container limits the visible area.
    ...
    const isKeyboardAccessible = (el: HTMLElement) => {
      // SIA-R84: If it scrolls, it MUST have a tabindex OR a focusable child
      const hasTabIndex = el.tabIndex >= 0;

      // Check for any focusable children (ignoring aria-hidden for a moment
      // to see if the container is fundamentally capable of focus)
      const hasFocusableChild =
        el.querySelector('a, button, input, [tabindex="0"]') !== null;

      return hasTabIndex || hasFocusableChild;
    };
    ...
    const scrollableCandidates = Array.from(document.querySelectorAll("*"))
      ...
      // REMOVE 'isVisible' here, or modify it to allow .card-hover
      .filter((el) => {
        // If it's hidden but is a .card-hover, we must check it anyway
        if (el.classList.contains("card-hover")) return true;
        return isVisible(el);
      })
      .filter((el) => !isRootElement(el))
      .filter(isScrollableSiteImprove);
    ...
    document
      .querySelectorAll(
        "input:not([type='hidden']):not([type='submit']):not([type='button']):not([type='reset']):not([type='image']), select, textarea, [role='textbox'], [role='combobox'], [role='listbox']",
      )
      .forEach((el) => {
        if (!isVisible(el)) return;
      ...
      if (animDurVal > 0.3) {
        ...
        if (animName && animName !== "none") {
          results.push({
            ruleId: "SIA-R95",
            impact: "moderate",
            description: `Element has CSS animation "${animName}" (${animDuration}) — ensure it is disabled or reduced via @media (prefers-reduced-motion: reduce)`,
            element: outerHtmlSnippet(el),
            selector: getSelector(el),
          });
          return;
